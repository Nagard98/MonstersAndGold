...
public class OldPathGenerator : MonoBehaviour
{
    ...
    {
        Vector3[] curveControlPoints = GenerateWaypoints(chunkSettings.BeelineLength, chunkSettings.NumCurves, lastChunkIndex, chunkZSize, chunkXSize, pathMaxWidth);
    ...
    private void GenerateChunk(int chunkIndex)
    {
        ...
        OldPathChunk chunkComponent = newChunk.AddComponent<OldPathChunk>();
    ...
    private ChunkSplats SetupSplatmaps(SplatHeight[] splatHeights, float[,,] splatmaps)
    {
